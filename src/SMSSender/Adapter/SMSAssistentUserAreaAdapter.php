...
class SMSAssistentUserAreaAdapter implements AdapterInterface, ServiceLocatorAwareInterface
{
    ...
    public function send(MessageInterface $message)
    {
        ...
        $serviceURL = "https://userarea.sms-assistent.by/api/v1/send_sms/plain?";
